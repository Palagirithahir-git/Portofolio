const projects = [
  {
    title: "ElectroMart",
    description:
      "Developed a responsive AI-powered e-commerce web application for electronic products using Next.js, React.js, TypeScript, JavaScript, HTML5, CSS, and Tailwind CSS.",
    technologies: [
      "Next.js",
      "React",
      "Tailwind CSS",
    ...
    github:
      "https://github.com/Palagirithahir-git/E-commerce-Customer-support-chatbot-AI-And-ML",
...

  {
    ...
    description:
      "Developed a responsive Task Management System to organize daily tasks. Implemented Create, Read, Update, and Delete (CRUD) functionality. Added task status management and user-friendly navigation. Used Local Storage to save tasks and retain data after page refresh. Designed a clean and responsive interface for a better user experience.",
    technologies: [
      "Java",
      "Spring Boot",
      "MySQL",
    ...
    github:
      "https://github.com/Palagirithahir-git/Command-Hub-Task-Manager-System",
